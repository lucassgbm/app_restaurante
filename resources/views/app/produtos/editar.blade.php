        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-header">.: Editar: {{ $produto->nome_produto }}</div>
                    <div class="card-body">
                        <form method="post" action="{{ route('produtos.update', ['produto' => $produto->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="data_validade" name="data_validade" placeholder="dd/mm/aaaa" value="{{ date('d/m/Y', strtotime($produto->data_validade)) }}">
                            ...
                            <div class="mb-3">
                                ...
                                {{-- verificar qual é o tipo preenchido no cadastro do produto --}}
                            ...
                            <div class="mb-3">
                                ...
                                {{-- verificar qual é o fornecedor preenchido no cadastro do produto --}}
